...
function HeroSection() {
  return (
    <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24 bg-gradient-to-br from-[#0B3D91] via-[#0B3D91] to-[#1B7F5B] overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-base sm:text-xl text-white/90 mb-8 sm:mb-10 leading-relaxed"
          >
          ...
          >
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 bg-[#1B7F5B] text-white rounded-lg font-semibold hover:bg-[#166646] transition-colors"
            >
              Contact Us
            </Link>
          </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {homepageData.impactStats.map((stat, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-center p-6 sm:p-8 rounded-2xl bg-[#F5F5F5] hover:shadow-lg transition-shadow"
            >
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <img
                ...
                className="rounded-2xl object-cover h-56 sm:h-64 w-full shadow-lg"
                onError={(event) => {
              ...
              <img
                ...
                className="rounded-2xl object-cover h-56 sm:h-64 w-full shadow-lg sm:mt-8"
                onError={(event) => {
                  const target = event.currentTarget;
          ...
          {servicesData.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 hover:shadow-xl hover:border-[#1B7F5B] transition-all group"
              >
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <Link
              to="/about"
              className="inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-[#0B3D91] transition-colors"
            >
              Learn More
            </Link>
          </motion.div>
